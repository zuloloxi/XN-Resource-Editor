...
//--------------------------------------------------------------------------
  ...
  CERT_STORE_PROV_COLLECTION        = PAnsiChar (11);
  CERT_STORE_PROV_SYSTEM_REGISTRY_A = PAnsiChar (12);
  CERT_STORE_PROV_SYSTEM_REGISTRY_W = PAnsiChar (13);
  CERT_STORE_PROV_SYSTEM_REGISTRY   = CERT_STORE_PROV_SYSTEM_REGISTRY_W;
  CERT_STORE_PROV_PHYSICAL_W        = PAnsiChar (14);
  CERT_STORE_PROV_PHYSICAL          = CERT_STORE_PROV_PHYSICAL_W;
  CERT_STORE_PROV_SMART_CARD_W      = PAnsiChar (15);
  CERT_STORE_PROV_SMART_CARD        = CERT_STORE_PROV_SMART_CARD_W;
  CERT_STORE_PROV_LDAP_W            = PAnsiChar (16);
...
function CryptHashData (hHash : HCRYPTHASH; data : PByte; dwDataLen : DWORD; dwFlags : DWORD) : BOOL; stdcall;
...
function CertOpenSystemStore (hProv : HCRYPTPROV; szSubsystemProtocol : PChar) : HCERTSTORE; stdcall;
...
function CryptGetHashParam (hHash : HCRYPTHASH; dwParam : DWORD; data : PByte; var dataLen : DWORD; flags : DWORD) : BOOL; stdcall;
...
function CertOpenSystemStore; external certdll name 'CertOpenSystemStoreW';
function CertGetNameString; external certdll name 'CertGetNameStringW';
{$else}
function CryptAcquireContext; external cryptdll name 'CryptAcquireContextA';
function CertOpenSystemStore; external certdll name 'CertOpenSystemStoreA';
...
function CryptGetHashParam; external cryptdll;
