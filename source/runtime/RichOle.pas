...
type
  IRichEditOle = interface (IUnknown)
    ...
    function ConvertObject (iob : Longint; const rclsidNew : TCLSID; lpstrUserTypeNew : PAnsiChar) : HRESULT; stdcall;
    function ActivateAs (const clsid : TCLSID; const clsidAs : TCLSID) : HRESULT; stdcall;
    function SetHostNames (lpstrContainerApp : PAnsiChar; lpstrContainerObj : PAnsiChar) : HRESULT; stdcall;
