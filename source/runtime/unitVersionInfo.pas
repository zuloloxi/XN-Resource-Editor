(*======================================================================*
 | unitVersionInfo                                                      |
 |                                                                      |
 | Simple Windows Version Info class                                    |
 |                                                                      |
 ...
 |                                                                      |
 | Copyright © Colin Wilson 2002-2007  All Rights Reserved              |
 *======================================================================*)
...
type
  ...
  public
    ...
    constructor Create (AVersionInfo : PByte); overload;
...
constructor TVersionInfo.Create(AVersionInfo: PByte);
begin
  fChildStrings := TStringList.Create;
  fTranslations := TList.Create;
...
var
  ...
  function GetVersionHeader (var p : PByte; var wLength, wValueLength, wType : word; var key : string) : Integer;
  var
    szKey : PWideChar;
    baseP : PByte;
  begin
