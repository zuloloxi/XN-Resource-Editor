...
// Stream class used to support EM_STREAMIN & EM_STREAMOUT
  ...
  public
    ...
    procedure GetWideString (var ws: UnicodeString);
 ...
 *----------------------------------------------------------------------*)
function TCustomExRichEdit.GetSelText: UnicodeString;
begin
 ...
 *----------------------------------------------------------------------*)
function TCustomExRichEdit.GetText: UnicodeString;
begin
 ...
 *----------------------------------------------------------------------*)
procedure TCustomExRichEdit.SetSelText(const Value: UnicodeString);
begin
 ...
 *----------------------------------------------------------------------*)
procedure TCustomExRichEdit.SetText(const Value: UnicodeString);
var
  st: string;
begin
  if HandleAllocated then
...
procedure TRichEditStream.GetWideString(var ws: UnicodeString);
begin
 ...
 *----------------------------------------------------------------------*)
function TRichEdit2_3Provider.RawGetText(sel: Boolean): UnicodeString;
var
 ...
 *----------------------------------------------------------------------*)
procedure TRichEdit2_3Provider.RawSetText(const st: UnicodeString;
  sel: Boolean);
var
  editStream: TEditStream;
  stream: TRichEditStream;
...
var
  ...
  SaveRect: TRect;
begin
  ZeroMemory (@Range, SizeOf(TFormatRange));
...
function AdjustForCRLF (ss: Integer; const txt: UnicodeString): Integer;
var
  i: Integer;
begin
  Result := ss;
